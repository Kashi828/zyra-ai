...
/// Describes the expected API target for the current Flutter runtime.
...
class ZyraConnectionTarget {
  ...
  static ZyraConnectionTarget resolve({String? configuredUrl}) {
    ...
    if (Platform.isAndroid) {
      ...
      return ZyraConnectionTarget(uri: uri, source: ZyraConnectionTargetSource.androidEmulatorBridge);
    }
